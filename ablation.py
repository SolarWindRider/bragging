from utils import GanTrainDataLoader, Generator, GanData, Discrimitor, seed_all, savecheckpoint
...
if __name__ == '__main__':
    ...
    parser.add_argument("-d_extra", "--extra_steps4discriminitor", type=float, default=0.2)
